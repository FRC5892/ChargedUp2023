...
public class ChaseTagCommand extends CommandBase {
  ...
  private static final int targetedTag = 2;
  private static final Transform3d distanceToTag = 
      new Transform3d(
  ...
  public void execute() {
    ...
    if (photonRes.hasTargets()) {
      ...
      var targetOpt = photonRes.getTargets().stream()
          .filter(t -> t.getFiducialId() == targetedTag)
      ...
      if (targetOpt.isPresent()) {
        ...
        var goalPose = targetPose.transformBy(distanceToTag).toPose2d();
