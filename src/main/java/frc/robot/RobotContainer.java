...
public class RobotContainer {
    ...
    // VisionSubsystem();
    public final static Led ledSubsystem = new Led(gyro);
    ...
    /* LED Commands */
    private final PurpleLights purpleLights = new PurpleLights(ledSubsystem);
    private final YellowLights yellowLights = new YellowLights(ledSubsystem);
