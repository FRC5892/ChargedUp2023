...
public class RobotContainer {
    ...
    /* Pneumatics Commands */
    public final Command intake = new intake(ground_intake, LEDs);
    public final Command outtake = new scoreShort(ground_intake, LEDs);
    public final Command retract = new retract(ground_intake, LEDs);
    public final Command outtakeFull = new scoreFull(ground_intake, LEDs);
    ...
    public Command getAutonomousCommand() {
        ...
        return new executeTrajectory(s_Swerve, autoChooser.getSelected(), outtake, retract, intake, passiveBalance,
                outtakeFull);
    }
}
